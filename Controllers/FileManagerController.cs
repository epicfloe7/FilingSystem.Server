...
namespace FilingSystem.Server.Controllers
{
    ...
    public class FileManagerController : ControllerBase
    {
        ...
        public async Task<HttpResponseMessage>  DownloadFile(string folder_name, string file_name)
        {
            string path = $@"C:\Users\tigra\source\repos\FilingSystem.Server\ContentFolders\{folder_name}\{file_name}";

            string download_path = $@"C:\Users\tigra\Downloads\{file_name}";            
            ...
            //else
            //{
            //    return Ok(File(await System.IO.File.ReadAllBytesAsync(path),mimeType,System.IO.Path.GetFileName(path)));
            //}
        }
    }
}
